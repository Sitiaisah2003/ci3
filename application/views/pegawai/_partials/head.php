<head>
        ...
        <link href="<?php echo base_url('assets/bootstrap/css/tes.css') ?>" rel="stylesheet">
        ...
        <link href="<?php echo base_url('assets/adminlte/css/skins/skin-blue-light.min.css') ?>" rel="stylesheet">
