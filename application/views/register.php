                ...
                <form class="mx-1 mx-md-4">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                   ...
                   <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="password"   class="form-control" <?php echo form_error('sandi') ? 'is-invalid':'' ?> name="sandi" />
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="text" placeholder="admin/pegawai"  class="form-control" <?php echo form_error('level') ? 'is-invalid':'' ?> name="level" />
