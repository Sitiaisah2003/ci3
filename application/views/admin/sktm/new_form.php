            ...
            <div id="layoutSidenav_content">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('admin/sktm/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card mb-3">
				
					<div class="card-body">

						<form action="<?php echo site_url('admin/sktm/add') ?>" method="post" enctype="multipart/form-data" >
